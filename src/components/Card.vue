<template>
  <div class="plan_item" v-if="cardInfo.type == 'ty01'">
    ...
    <v-tooltip v-model="tooltip[0]" :activator="`#${cardInfo.name}-1`" location="bottom" offset="0" transition="false" :open-on-hover="false" scroll-strategy="none" no-click-animation contained>
    ...
    <v-tooltip v-model="tooltip[1]" :activator="`#${cardInfo.name}-2`" location="bottom" offset="0" transition="false" :open-on-hover="false" scroll-strategy="none" no-click-animation contained>
      <div class="tooltip_content">
        LG U+ 인터넷/IPTV 신규 가입 + 알뜰폰 결합 시, 최대 118만원의 혜택을 받을 수 있어요!
      </div>
    </v-tooltip>
      
    <div class="acdItem" :class="{ on : detail }">
      <div class="card_bot">
  ...
  <div class="plan_item" v-if="cardInfo.type == 'ty02'">
    ...
    <v-tooltip v-model="tooltip[2]" :activator="`#${cardInfo.name}-1`" location="bottom" offset="0" transition="false" :open-on-hover="false" scroll-strategy="none" no-click-animation contained>
      <div class="tooltip_content">
        데이터 소진 시 유튜브 화질 1080p로 원활히 볼 수 있어요
      </div>
    </v-tooltip>
